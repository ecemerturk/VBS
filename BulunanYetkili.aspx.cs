...
public partial class Default2 : System.Web.UI.Page
{
    ...
    protected void ButtonDuzenle_Click(object sender, EventArgs e)
    {
        ...
        query1 += nl + "SET YETKILI_MAIL='" + TextMail.Text + "', YETKILI_TELEFON='" + TextTel.Text + "', YETKILI_BRANS='" + TextBrans.Text + "' ";
        query1 += nl + "WHERE YETKILI_ID='" + Session["secilen"] + "'";
        ...
        query2 += nl + "WHERE K.KISI_ID='" + Session["secilen"] + "' AND K.KISI_ID = Y.YETKILI_ID";
        
        SqlQuery sqlquery2 = new SqlQuery();
        DataTable datatable2 = sqlquery2.Query(query2);
        TextAd .Text = datatable2.Rows[0][2].ToString();
        TextSoyad.Text = datatable2.Rows[0][3].ToString();
        TextDogum.Text = datatable2.Rows[0][4].ToString();
        TextKan.Text = datatable2.Rows[0][5].ToString();
        TextMail.Text = datatable2.Rows[0][6].ToString();
        TextTel.Text = datatable2.Rows[0][7].ToString();
        TextBrans.Text = datatable2.Rows[0][8].ToString();
        TextID.ReadOnly = true;
        TextTC.ReadOnly = true;
    }
